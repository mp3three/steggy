import { FormioJSValidationConfig } from '@formio/contracts';
import { LIB_SERVER } from '@formio/contracts/constants';
import { FormDTO, SubmissionDTO } from '@formio/contracts/formio-sdk';
import { APIRequest, JWT_HEADER } from '@formio/contracts/server';
import type { FormValidator } from '@formio/contracts/validation';
import { SubmissionDocument } from '@formio/persistence/mongo';
import { InjectLogger, InjectMongo, Trace } from '@formio/utilities';
import { Formio } from '@formio/wrapper';
