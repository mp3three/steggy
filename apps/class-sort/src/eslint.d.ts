// Basically @types/eslint, but IT ACTUALLY EXPORTS THE TYPES
// WTF
//
// Yes, I'm salty
...
export namespace SourceCode {
  ...
  export interface UnaryNodeCursorWithSkipOptions {
    <T extends AST.Token>(
      node: ESTree.Node,
      options:
  ...
  export interface UnaryNodeCursorWithCountOptions {
    <T extends AST.Token>(
      node: ESTree.Node,
      options:
        | ((token: AST.Token) => token is T)
  ...
  export interface UnaryCursorWithSkipOptions {
    <T extends AST.Token>(
  ...
  export interface UnaryCursorWithCountOptions {
    <T extends AST.Token>(
      node: ESTree.Node | AST.Token | ESTree.Comment,
      options:
        | ((token: AST.Token) => token is T)
  ...
  export interface BinaryCursorWithSkipOptions {
    <T extends AST.Token>(
      left: ESTree.Node | AST.Token | ESTree.Comment,
      right: ESTree.Node | AST.Token | ESTree.Comment,
      options:
  ...
  export interface BinaryCursorWithCountOptions {
    <T extends AST.Token>(
      left: ESTree.Node | AST.Token | ESTree.Comment,
      right: ESTree.Node | AST.Token | ESTree.Comment,
      options:
...
export namespace Rule {
  ...
  export type NodeTypes = ESTree.Node['type'];
  ...
  export interface RuleListener extends NodeListener {
  ...
  export interface RuleContext<T extends unknown = unknown> {
    id: string;
    options: T[];
  ...
  export interface ReportDescriptorOptionsBase {
  ...
  export interface ReportDescriptorOptions extends ReportDescriptorOptionsBase {
...
export namespace Linter {
  ...
  type RuleLevelAndOptions<Options extends unknown[] = unknown[]> = Prepend<
    Partial<Options>,
    RuleLevel
  >;

  type RuleEntry<Options extends unknown[] = unknown[]> =
    | RuleLevel
  ...
  export interface HasRules<Rules extends RulesRecord = RulesRecord> {
    rules?: Partial<Rules> | undefined;
  }

  export interface BaseConfig<Rules extends RulesRecord = RulesRecord>
    ...
    settings?: { [name: string]: unknown } | undefined;
  }

  export interface ConfigOverride<Rules extends RulesRecord = RulesRecord>
  ...
  export type ParserModule =
    | {
        parse(text: string, options?: unknown): AST.Program;
      }
    | {
...
export namespace CLIEngine {
  export class Options {
    allowInlineConfig?: boolean | undefined;
    baseConfig?: false | { [name: string]: unknown } | undefined;
    cache?: boolean | undefined;
