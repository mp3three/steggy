...
export class DownstairsService implements RoomController {
  ...
  @Trace()
  @OnEvent(`${ROOM_NAMES.downstairs}/areaOff`)
  public async areaOff(): Promise<boolean> {
    return true;
  }

  @Trace()
  @OnEvent(`${ROOM_NAMES.downstairs}/areaOn`)
  public async areaOn(): Promise<boolean> {
    return true;
  }

  @Trace()
  @OnEvent(`${ROOM_NAMES.downstairs}/dimDown`)
  public async dimDown(): Promise<boolean> {
    return true;
  }

  @Trace()
  @OnEvent(`${ROOM_NAMES.downstairs}/dimUp`)
  public async dimUp(): Promise<boolean> {
    return true;
  }

  @Trace()
  @OnEvent(`${ROOM_NAMES.downstairs}/favorite`)
